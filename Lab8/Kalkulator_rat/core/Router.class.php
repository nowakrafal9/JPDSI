<?php
    ...
    class Router {
        ...
        public function setDefaultRoute($route) { $this->default = $route; }
        
        public function setLoginRoute($route) { $this->login = $route; }
        ...
        private function control($namespace, $controller, $method, $roles = null) {
            if (!empty($roles)) {
                ...
                } else { if (inRole($roles)) $found = true; }
            ...
            } else { $controller = $namespace . "\\" . $controller; }
        ...
        public function go() {
            if (isset($this->routes[$this->action])) {
                ...
                if (isset($this->default) && isset($this->routes[$this->default])) {
                    ...
                    $this->control($r->namespace, $r->controller, $r->method, $r->roles);
                } else { throw new Exception('Route for "' . $this->action . '" is not defined'); }
            }
        }
    }